...
public class RequestPrivateController {
    ...
    @PostMapping("/{eventId}")
    ParticipationRequestDto saveRequest(@PathVariable long userId,
    ...
    @GetMapping
    List<ParticipationRequestDto> getRequestByUser(@PathVariable long userId) {
    ...
    ParticipationRequestDto cancelRequestByUser(@PathVariable long userId,
